...
// ✅ FIXED: localhost removed, Vite env used
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-indigo-300 text-sm mt-1">Sign in to continue your journey</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-indigo-500 text-xs">or continue with email</span>
        <div className="flex-1 h-px bg-indigo-900/60" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-indigo-900/20 border border-indigo-700/40 rounded-xl pl-10 pr-4 py-2.5 text-white"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          <div className="flex justify-between">
            ...
            <Link to="/forgot-password" className="text-xs text-indigo-400">Forgot?</Link>
          </div>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-indigo-900/20 border border-indigo-700/40 rounded-xl pl-10 pr-10 py-2.5 text-white"
            />
        ...
        <button type="submit" disabled={loading}
          className="w-full bg-indigo-600 py-2.5 rounded-xl text-white">
